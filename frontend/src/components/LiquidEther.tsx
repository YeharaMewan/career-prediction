...
const defaultColors = ["#22577a", "#38a3a5", "#57cc99", "#80ed99", "#c7f9cc"];
  ...
  useEffect(() => {
    ...
    class Advection extends ShaderPass {
      ...
      constructor(simProps: AdvectionProps) {
        ...
        this.uniforms = this.props.material!.uniforms; // Non-null assertion: material is always defined here
        this.init();
      }
    ...
    interface ExternalForceProps extends ShaderPassProps {
      cellScale: THREE.Vector2;
      cursor_size: number;
      dst: THREE.WebGLRenderTarget;
    }
    ...
    class ExternalForce extends ShaderPass {
      mouse!: THREE.Mesh;
      private simProps: { cellScale: THREE.Vector2; cursor_size: number };
    ...
    class Viscous extends ShaderPass {
      ...
      update(props: ViscousUpdateProps = {}): THREE.WebGLRenderTarget | undefined {
        const { viscous, iterations, dt } = props;
        if (!this.uniforms) return undefined;
        let fbo_in: THREE.WebGLRenderTarget | undefined;
        let fbo_out: THREE.WebGLRenderTarget | undefined = undefined;
    ...
    class Poisson extends ShaderPass {
      ...
      update(props: PoissonUpdateProps = {}): THREE.WebGLRenderTarget | undefined {
        const { iterations } = props;
        let p_in: THREE.WebGLRenderTarget | undefined;
        let p_out: THREE.WebGLRenderTarget | undefined = undefined;
        const iter = iterations ?? 0;
        if (iter === 0) return undefined;
        for (let i = 0; i < iter; i++) {
          if (i % 2 === 0) {
    ...
    class Simulation {
      ...
      update() {
        ...
        let vel: THREE.WebGLRenderTarget | undefined = this.fbos.vel_1;
